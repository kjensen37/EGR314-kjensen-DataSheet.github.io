...
**Final Thoughts:** Other than the changes as previously stated, I quite liked the design of my PCB. The section with all of the resistors and capacitors was a nightmare to wire on KiCAD, but I think it was worth it. I liked the placement of my power and my buttons, although I wish I had added a power connection from the USB port so that I would not need to have a barrel jack connection along with a USB connection in order to code my ESP32. I also think the placement of my upstream and downstream headers was a great feature for ease of access.
